...
import $ from 'jquery';
import {
    Layout, Header, HeaderRow, HeaderTabs, Tab, Content, Grid,
    FABButton, Icon, List, ListItem, ListItemContent, Tooltip
} from 'react-mdl';
        ...
        return (
            <div>
                <List style={{paddingLeft: '90px'}}>
                    <ListItem>
                        <ListItemContent
                            icon="account_circle">{this.state.profile && this.state.profile.bio}</ListItemContent>
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                        <ListItemContent
                            icon="home">{this.state.profile.address}, {this.state.profile.city}, {this.state.profile.state} {this.state.profile.zip_code}</ListItemContent>
                    </ListItem>
                    <ListItem>
        ...
        return (
            <div>
                ...
                <div className={classNames('mdl-demo', 'mdl-base')}>
                    ...
                    <Layout fixedHeader
                            className={classNames(getColorClass('grey', 100), getTextColorClass('grey', 700))}>
                        <Header className={getColorClass('primary')} title="Material Design Lite" scroll>

                            <FABButton style={{position: 'absolute', margin: '13.33px'}} colored ripple
