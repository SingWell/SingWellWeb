...
import {
    Layout, Header, HeaderRow, HeaderTabs, Tab, Content, Grid, Cell, Tooltip,
    FABButton, Icon, Card, CardTitle, List, ListItem, ListItemContent, CardText
} from 'react-mdl';
...
class Organizations extends Component {
                ...
                <Grid component="section" className="section--center" noSpacing>
                    <Cell col={6}>
                        <Card shadow={0} style={{margin: '10px auto', minHeight: "0px"}}>
                            ...
                            <CardText>
                                Pig ham prosciutto ground round brisket biltong spare ribs jowl meatloaf rump drumstick
                                salami doner capicola tri-tip.
                            </CardText>
                        </Card>
                    </Cell>
                    <Cell col={6}>
                        <Card shadow={0} style={{margin: '10px auto', minHeight: "0px"}}>
                            ...
                            <CardText>
                                Bacon ipsum dolor amet fatback pork belly pork loin ribeye, cupim short ribs jowl
                                frankfurter buffalo leberkas.
                            </CardText>
                ...
                <Grid component="section" className="section--center" shadow={0} noSpacing>
                    ...
                    <Cell col={12}>
                        <List className="title__padding">
                            ...
                            <ListItem>
                                <ListItemContent icon="link"><a style={{color: "rgb(0, 0, 240)"}}
                                                                href={this.state.orgGet.website_url}>{this.state.orgGet.website_url}</a></ListItemContent>
                            </ListItem>
    ...
    renderChoirs() {
        ...
        return (
            <div>
                <Grid component="section" className="section--center" shadow={0} noSpacing>
                    <Cell col={12}>
                        <FABButton style={{margin: '10px', float: "right"}} colored ripple
                                   onClick={() => this.props.history.push('/organizations/' + this.props.match.params.orgID + '/choirs/')}>
                            <Icon name="add"/>
                        </FABButton>
                    </Cell>
            ...
            return (
                <div style={cellStyle}>
                    ...
                    eventsTest[this.state.year][this.state.month.getMonth()][date].map((name, i) => (
                        <div
                            onClick={() => this.props.history.push('/organizations/' + this.props.match.params.orgID + '/events/' + name.split("&&&")[1])}
                            key={i} style={containerStyle}>
        ...
        return (
            <div className="title__margin">
                <Grid component="section" className="section--center" noSpacing>
                    <Cell col={12}>
                        <FABButton style={{margin: '10px', float: "right"}} colored ripple
                                   onClick={() => this.props.history.push('/organizations/' + this.props.match.params.orgID + '/events')}>
                            <Icon name="add"/>
                        </FABButton>
                    </Cell>
                    <Cell col={12}>
    ...
    renderMusicLibrary() {
        ...
        return (
            <div className="title__padding">
                <FABButton style={{margin: '10px', float: "right"}} colored ripple
                           onClick={() => this.props.history.push('/organizations/' + this.props.match.params.orgID + '/music')}>
                    <Icon name="add"/>
                </FABButton>
                <Grid component="section" className="section--center" noSpacing>
                    <Cell col={3}>
    ...
    renderActiveTabContent() {
        switch (this.state.activeHeaderTab) {
            ...
            case 1:
                return this.renderChoirs();
            case 2:
                return this.renderEvents();
            case 3:
                return this.renderMusicLibrary();
            default:
